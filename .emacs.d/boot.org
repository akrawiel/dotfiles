...
#+begin_src emacs-lisp
  ...
  (akrw/leader-keys
    :keymaps 'override
    "f" '(:ignore t :wk "files")
    "fr" '(counsel-projectile-rg :wk "rg over project")
    "fh" '(counsel-recentf :wk "recent files")
    "fp" '(akrw/search-config :wk "config files")
    "ff" '(counsel-find-file :wk "find file from current dir")
    "fs" '(save-buffer :wk "save file")
    "RET" '(counsel-M-x :wk "rg over project")
  ...
  (general-define-key
   :keymaps '(ivy-minibuffer-map ivy-switch-buffer-map ivy-reverse-i-search-map)
   "C-j" 'ivy-next-line
